  ...
  return (
    <section id="philosophy" className="py-24">
      <div className="mx-auto max-w-2xl px-6">
        ...
        <p className="mt-6 text-foreground text-xl font-medium text-balance text-left md:text-center">
          We believe everyone deserves access to a supportive AI companion—without paying for it
          or surrendering your privacy.
        </p>

        <div className="mt-10 space-y-5 text-muted-foreground text-lg text-balance text-left md:text-center">
          <p>
